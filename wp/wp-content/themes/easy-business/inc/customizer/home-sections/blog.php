...
$wp_customize->add_section( 'section_blog',
	array(
		'title'      => __( 'Latest Posts', 'easy-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[enable_blog_section]', 
	array(		
	'label' 	=> __('Enable Latest Posts Section', 'easy-business'),
...
$wp_customize->add_control('theme_options[blog_section_title]', 
	...
	'active_callback' => 'easy_business_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       		=> __( 'Number of Posts', 'easy-business' ),
...
$wp_customize->add_control(
	new easy_business_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'easy-business' ),
		'section'  => 'section_blog',
