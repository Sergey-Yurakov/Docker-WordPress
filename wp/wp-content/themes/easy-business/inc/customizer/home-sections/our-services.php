...
$wp_customize->add_section( 'section_our_services',
	array(
	'title'      => __( 'Our Services', 'easy-business' ),
	'priority'   => 100,
...
$wp_customize->add_control('theme_options[enable_our_services_section]', 
	array(		
	'label' 	=> __('Enable Our Services Section', 'easy-business'),
...
$wp_customize->add_control('theme_options[our_services_section_title]', 
	...
	'active_callback' => 'easy_business_our_services_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control('theme_options[our_services_content_type]', 
	...
	'active_callback' => 'easy_business_our_services_active',
	'choices'	  => array(
			'our_services_page'	  => __('Page','easy-business'),
			'our_services_post'	  => __('Post','easy-business'),
		),
	)
);
...
for( $i=1; $i<=$number_of_our_services_items; $i++ ) {
	...
	$wp_customize->add_control('theme_options[our_services_icon_'.$i.']', 
		array(
		'label'       => sprintf( __('Select Icon #%1$s', 'easy-business'), $i),
		'description' => sprintf( __('Please input icon as eg: fas fa-home. Find Font Aawesome icons %1$shere%2$s', 'easy-business'), '<a href="' . esc_url( 'https://fontawesome.com/icons' ) . '" target="_blank">', '</a>' ),
		'section'     => 'section_our_services',   
	...
	$wp_customize->add_control('theme_options[our_services_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'easy_business_our_services_page',
		)
	);
	...
	$wp_customize->add_control('theme_options[our_services_post_'.$i.']', 
		...
		'active_callback' => 'easy_business_our_services_post',
		)
	);
}